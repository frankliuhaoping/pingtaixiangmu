            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zyfName" name="zyfName" class="form-control" placeholder="<spring:message code="pubRes.parentZy" />" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zymc" class="col-sm-3 control-label"><span class="fieldRequired">*</span>&nbsp;<spring:message code="pubRes.zymc" />:</label>
                        <div class="col-sm-9">
                            <input id="zymc" name="zymc" class="form-control" placeholder="<spring:message code="pubRes.zymc" />" required maxlength="32">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zyurl" name="zyurl" class="form-control" placeholder="<spring:message code="pubRes.zyurl" />" maxlength="128">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="qxdm" class="col-sm-3 control-label"><spring:message code="pubRes.qxdm" />:</label>
                        <div class="col-sm-9">
                            <input id="qxdm" name="qxdm" class="form-control" placeholder="<spring:message code="pubRes.qxdm" />" maxlength="32">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="fieldRequired">*</span>&nbsp;<spring:message code="pubRes.zylx" />:</label>
                        <div class="col-sm-9">
                            <select name="zylx" class="form-control" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" placeholder="<spring:message code="pxdm" />" value="0" maxlength="8" digits="true" onblur="if('' == this.value) this.value = 0">
                        </div>
                    </div>
                    <div class="form-group">
...
$(function () {
    ...
    $('#cancelBtn').click(function(){
        Manage.url("<c:url value='/pubRes/index' />?yyid=${param.yyid}");
    });
