            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yymc" name="yymc" class="form-control" required  maxlength="10" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yyaqm" name="yyaqm" class="form-control" maxLength="64" noChinese="true">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control"  digits="true" onblur="if('' == this.value) this.value = 0" maxlength="8">
                        </div>
                    </div>
                    <div class="form-group">
...
$(function () {
    ...
    //构建应用类型下拉框
    addSelect ("<c:url value='/pubXtzd/getPubXtzdList' />", "yylx", "system_yylx", pubApp.yylx);
