	...
	<div class="wrapper wrapper-content">
		<div class="ibox float-e-margins">
			<div class="ibox-title">
				<h5>
					<spring:message code="pubZzjg.view" />
				</h5>
			</div>
			<div class="ibox-content">
				<form class="form-horizontal row label-title">
					<input id="dwdm" name="dwdm" type="hidden">
					<div class="col-sm-12">
					    <%-- 第一行  begin --%>
						<div class="row">
							<div class="form-group col-sm-4">
								<label for="gxdwjc" class="col-sm-4 control-label"><spring:message
										code="pubZzjg.gxdwjc" />:
								</label>
								<div class="col-sm-8">
									<input id="gxdwjc" name="gxdwjc" class="form-control"
										readonly="readonly" />
								</div>
							</div>

							<div class="form-group col-sm-4">
								<label for="gxdwdm" class="col-sm-4 control-label"><spring:message
										code="pubZzjg.gxdwdm" />:
								</label>
								<div class="col-sm-8">
									<input id="gxdwdm" name="gxdwdm" class="form-control"
										readonly="readonly" />
								</div>
							</div>

							<div class="form-group col-sm-4">
								<label for="dwdm" class="col-sm-4 control-label"><spring:message
										code="pubZzjg.dwdm" />:
								</label>
								<div class="col-sm-8">
						...
						<div class="row">
							<div class="form-group col-sm-4">
								<label for="dwmc" class="col-sm-4 control-label"><spring:message
										code="pubZzjg.dwmc" />:
								</label>
								<div class="col-sm-8">
				...
				<form class="form-horizontal formW60p clearfix">
