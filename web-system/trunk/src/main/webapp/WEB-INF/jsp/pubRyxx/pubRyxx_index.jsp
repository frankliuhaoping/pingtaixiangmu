							...
							<table class="table table-bordered table-striped" treeGrid="true"
								...
								<thead>
									<tr>
										...
										<th data-field="rybh" data-sortable="true"
											data-sort-name="rybh" data-visible="false"><spring:message
												code="pubRyxx.rybh" /></th>
										<th data-field="ryxm" data-sortable="true"
											data-sort-name="ryxm"><spring:message
												code="pubRyxx.ryxm" /></th>
										<!-- 人员姓名列 -->
										<th data-field="xbms" data-sortable="true"
											data-sort-name="xbms"><spring:message
												code="pubRyxx.ryxb" /></th>
										<!-- 人员性别列 -->
										<th data-field="csny" data-sortable="true"
											data-sort-name="csny" data-formatter="csnyFormatter"><spring:message
												code="pubRyxx.csny" /></th>
										<!-- 出生年月列 -->
										<th data-field="zwms" data-sortable="true"
											data-sort-name="zwms"><spring:message
												code="pubRyxx.ryzw" /></th>
										<!-- 人员职务列 -->
										<th data-field="ssdwmc" data-sortable="true"
											data-sort-name="ssdwmc"><spring:message
												code="pubRyxx.ssdwmc" /></th>
										<!-- 所属单位列 -->
										<th data-field="sybz" data-sortable="true"
											data-sort-name="sybz" data-formatter="sybzFormatter"><spring:message
												code="pubRyxx.sybz" /></th>
										<!--使用标志  -->
...
$(function () {
	...
	$("#addBtn").click(function(){
		  indexPage = Layer.openIframeByOptions(pubRyxxUrl.add,{});
	});
	// 删除 
...
/*修改人员信息  */
function edit(rowId) {
		indexPage = Layer.openIframeByOptions(pubRyxxUrl.edit + rowId,{});
}
/* 删除人员信息 */
function del(rowId) {
...
/* 查看人员信息 */
	function view(rowId) {
		indexPage = Layer.openIframeByOptions(pubRyxxUrl.view + rowId,{});
}
