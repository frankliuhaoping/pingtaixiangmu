		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form class="form-horizontal formW60p" method="post">
					<input id="lxbh" name="lxbh" type="hidden">
					<input id="sjbb" name="sjbb" type="hidden">
					...
					<div class="form-group">
						<label for="code" class="col-sm-3 control-label"><spring:message code="pubXtzdlx.lxdm" />:</label>
						<div class="col-sm-9">
							<input id="lxdm" name="lxdm" class="form-control" placeholder="<spring:message code="pubXtzdlx.lxdm" />"  required>
						</div>
					</div>
					<div class="form-group">
...
$(function () {
	...
	$('#saveBtn').click(function(){
		ManageForm.submitForm($('form'), "<c:url value='/pubXtzdlx/saveEdit' />", {submitFun:function(){$('#cancelBtn').click();}});
	});
