        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content pb10 clearfix">
				 ...
				 <div class=" J_mainContent">
					<div style="border: #ddd solid 1px;margin:0; padding: 10px 0;overflow:auto;"  id="myRecord">		
						<!-- <ul class="list-group"><li class="list-group-item noResultText">没有您的未提交报告</li></ul> -->
						<div id="authTree" class="jstree jstree-default" ></div>
...
function test(){
	...
	var url = "<c:url value='/pubZzjgsy/getOrgTreeView'/>";
	Manage.query (url+"?zdbh="+ $("#zdbh").val(), {}, function (result){
		authTree.jstree({
			'checkbox': {
				'keep_selected_style': false
				//'three_state':false
