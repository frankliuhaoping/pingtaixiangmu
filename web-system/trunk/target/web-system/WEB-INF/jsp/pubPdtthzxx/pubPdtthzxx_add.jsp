    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>
                    <spring:message code="pubPdtthzxx.add" />
            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                	...
                	<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="thzbh" name="thzbh" class="form-control"  required   maxLength="20">
                        </div>
                    </div>
                    <!-- 通话组名称 -->
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="thzmc" name="thzmc" class="form-control"  required   maxLength="20">
                        </div>
                    </div>
                    <!-- 组织机构名称 -->
                   <div class="form-group">
...
$(function () {
    ...
    $('#saveBtn').click(function(){
        ManageForm.submitForm($('form'), "<c:url value='/pubPdtthzxx/saveAdd' />", {submitFun:function(){$('#cancelBtn').click();}});
    });
