            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zdfName" name="zdfName" class="form-control timebox"  <c:if test="${not empty zdfName}">value="${zdfName}"</c:if> readOnly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zdxz" class="col-sm-3 control-label"><span class="fieldRequired">*</span>&nbsp;<spring:message code="pubXtzd.zdxz" />:</label>
                        <div class="col-sm-9">
                        	<input type="text" id="zdxz" name="zdxz" class="form-control" required maxlength="32" noChinese="true"/>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" value="0" maxlength="8" digits="true" onblur="if('' == this.value) this.value = 0" digits="true">
                        </div>
                    </div>
                    <div class="form-group">
