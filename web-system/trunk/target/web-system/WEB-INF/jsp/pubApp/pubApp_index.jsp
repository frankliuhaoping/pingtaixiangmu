    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><i class="fa fa-file-text-o mt2 mr5"></i><spring:message code="pubApp.select" /></h5>
            </div>
...
$(function () {
    ...
    $("#addBtn").click(function(){
        ...
        indexPage = Layer.openIframeByOptions(pubAppUrl.add,{});
    });
...
// 修改应用
function edit(rowId) {
	indexPage = Layer.openIframeByOptions(pubAppUrl.edit + rowId,{});
...
// 查看应用
function view(rowId) {
	indexPage = Layer.openIframeByOptions(pubAppUrl.view + rowId,{});
}
