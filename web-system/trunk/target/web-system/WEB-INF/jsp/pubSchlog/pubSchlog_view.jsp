            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                	<div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="rwzxid" name="rwzxid" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="fwdm" name="fwdm" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="rwmc" name="rwmc" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="cron" name="cron" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="lm" name="lm" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="ffm" class="col-sm-3 control-label"><spring:message code="pubSchlog.ffm" />:</label>
                        <div class="col-sm-9">
                            <textarea id="ffm" name="ffm" class="form-control" readonly="readonly"  rows="2"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zxip" name="zxip" class="form-control" readonly="readonly" >
                        </div>
                    </div>
