		...
		<div class="ibox float-e-margins">
			...
			<div class="ibox-content">
				<form class="form-horizontal formW60p">
					<input type="hidden" name="yhbh" /> <input type="hidden"
						name="sjbb" />
					<div class="form-group">
						<label for="yhzh" class="col-sm-3 control-label"> <span
							class="fieldRequired">*</span>&nbsp;<spring:message
								code="pubUser.yhzh" />:
						</label>
						<div class="col-sm-9">
							<input type="text" id="yhzh" name="yhzh" class="form-control" maxlength="32" readonly="readonly">
						</div>
					</div>
					<div class="form-group">
						<label for="yhmc" class="col-sm-3 control-label"> <span
							class="fieldRequired">*</span>&nbsp;<spring:message
								code="pubUser.yhmc" />:
						</label>
						<div class="col-sm-9">
							<input type="text" id="yhmc" name="yhmc" class="form-control" required maxlength="8">
						</div>
					</div>
					<div class="form-group">
						<label for="ssdwmc" class="col-sm-3 control-label"> <span
							class="fieldRequired">*</span>&nbsp;<spring:message
								code="pubUser.ssdwmc" />:
						</label>
						<div class="col-sm-9">
							<input type="text" id="ssdwmc" name="ssdwmc" class="form-control timebox" readonly="readonly" maxlength="16">
						</div>
						<input type="hidden" id="ssdwdm" name="ssdwdm">
					</div>
					<div class="form-group">
						<label for="dldwmc" class="col-sm-3 control-label"> <spring:message
								code="pubUser.dldwmc" />:
						</label>
						<div class="col-sm-9">
							<input type="text" id="dldwmc" name="dldwmc" class="form-control timebox" readonly="readonly" maxlength="16">
						</div>
						<input type="hidden" id="dldwdm" name="dldwdm">
					</div>
					<div class="form-group">
						<label for="xzqh" class="col-sm-3 control-label"> <spring:message
								code="pubUser.xzqh" />:
						</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label for="pkiid" class="col-sm-3 control-label"> <spring:message code="pubUser.pkiid" />:
						</label>
						<div class="col-sm-9">
							<input type="text" id="pkiid" name="pkiid" class="form-control" maxlength="32" noChinese="true">
						</div>
					</div>
					<div class="form-group">
						<label for="lxdh" class="col-sm-3 control-label"> <spring:message code="pubUser.lxdh" />:
						</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<label for="pxdm" class="col-sm-3 control-label"> <spring:message
								code="pubUser.pxdm" />:
						</label>
						<div class="col-sm-9">
