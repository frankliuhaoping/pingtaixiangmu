			...
			<div class="ibox-content">
				<form class="form-horizontal row label-title">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="zyfName" name="zyfName" class="form-control timebox"  readonly>
 						</div>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="olddwdm" name="olddwdm" class="form-control"  readonly >
                        </div>
                    </div>
                     -->
						...
						<div class="row">
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwdm" name="dwdm" class="form-control"
										 required
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwjc" name="dwjc" class="form-control" maxLength="32">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="jcpym" name="jcpym" class="form-control" maxLength="70" noChinese="true">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dhhm" name="dhhm" class="form-control" maxLength="256" manyMobiles="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="czhm" name="czhm" class="form-control" maxLength="256" manyMobiles="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dthm" name="dthm" class="form-control" maxLength="256" amount="true">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="yjdz" name="yjdz" class="form-control" maxLength="256" email="true">
								</div>
							</div>

							<div class="form-group col-sm-4">
								<label for="jhdwdm" class="col-sm-4 control-label"><span
									class="fieldRequired">*</span> <spring:message
										code="pubZzjg.jhdwdm" />:
								</label>
								<div class="col-sm-8">
									<input id="jhdwdm" name="jhdwdm" class="form-control" required maxLength="32" digits="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="jhdwmc" name="jhdwmc" class="form-control" maxLength="64">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwlb" name="dwlb" class="form-control" maxLength="2" noChinese="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwlbms" name="dwlbms" class="form-control" maxLength="16">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwjb" name="dwjb" class="form-control" maxLength="8">
								</div>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="slms" name="slms" class="form-control" maxLength="512">
								</div>
							</div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="yhsybz110" name="yhsybz110" class="form-control"  useMark="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="yhsybz122" name="yhsybz122" class="form-control"  useMark="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="yhsybz120" name="yhsybz120" class="form-control"  useMark="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="yhsybz119" name="yhsybz119" class="form-control"  useMark="true">
                        </div>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div class="col-sm-8">
                            <input id="qtyhsybz" name="qtyhsybz" class="form-control"  useMark="true">
                        </div>
                    </div>
                     -->
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dcsc" name="dcsc" class="form-control" maxLength="2" digits="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="kjjz" name="kjjz" class="form-control" maxLength="12" noChinese="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="jbdwbz" name="jbdwbz" class="form-control" maxLength="2" noChinese="true">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dwdz" name="dwdz" class="form-control" maxLength="64">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="jdwdm" name="jdwdm" class="form-control" maxLength="12" digits="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="jdwmc" name="jdwmc" class="form-control" maxLength="32">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="zgdwdm" name="zgdwdm" class="form-control" maxLength="12" digits="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="zgdwmc" name="zgdwmc" class="form-control" maxLength="64">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="xgbz" name="xgbz" class="form-control" maxLength="64">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dldwdm" name="dldwdm" class="form-control" maxLength="12" digits="true">
								</div>
							</div>
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="dldwmc" name="dldwmc" class="form-control" maxLength="64">
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="form-group col-sm-4">
								...
								<div class="col-sm-8">
									<input id="pxdm" name="pxdm" class="form-control" maxLength="8" digits="true">
								</div>
							</div>
