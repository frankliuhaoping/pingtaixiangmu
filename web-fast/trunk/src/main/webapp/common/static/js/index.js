$(function(){
    $('.navbar-static-side').mouseenter(function(){
       $('.open').removeClass("open");
    });
    $('.J_mainContent').mouseenter(function(){
       $('.open').removeClass("open");
    });
});
...
function n() {
    var t = $(this).attr("href"), a = $(this).data("index"), i = $.trim($(this).data('tab-title')), n = !0;
    if(!i) {i = $.trim($(this).text());}
