    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5>
                    <spring:message code="pubAudit.edit" />
            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="fwlj" name="fwlj" class="form-control" placeholder="<spring:message code="pubAudit.fwlj" />" required urlFormat="true" maxLength="128">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="sjms" name="sjms" class="form-control" placeholder="<spring:message code="pubAudit.sjms" />" maxLength="64">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" placeholder="<spring:message code="pubAudit.pxdm" />" digits="true" maxLength="8">
                        </div>
                    </div>
...
$(function () {
    ...
    $('#saveBtn').click(function(){
        ManageForm.submitForm($('form'), "<c:url value='/pubAudit/saveEdit' />", {submitFun:function(){$('#cancelBtn').click();}});
    });
