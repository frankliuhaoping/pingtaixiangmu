            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zyfName" name="zyfName" class="form-control" <c:if test="${not empty zyfName}">value="${zyfName}"</c:if> readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zymc" class="col-sm-3 control-label"><spring:message code="pubRes.zymc" />:</label>
                        <div class="col-sm-9">
                            <input id="zymc" name="zymc" class="form-control" required maxlength="32" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zytb" class="col-sm-3 control-label"><spring:message code="pubRes.zytb" />:</label>
                        <div class="col-sm-9">
                        	<input type="text" id="zytb" name="zytb" class="form-control" readonly="readonly"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zyurl" class="col-sm-3 control-label"><spring:message code="pubRes.zyurl" />:</label>
                        <div class="col-sm-9">
                            <input id="zyurl" name="zyurl" class="form-control" maxlength="128" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="qxdm" class="col-sm-3 control-label"><spring:message code="pubRes.qxdm" />:</label>
                        <div class="col-sm-9">
                            <input id="qxdm" name="qxdm" class="form-control" maxlength="32" readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
