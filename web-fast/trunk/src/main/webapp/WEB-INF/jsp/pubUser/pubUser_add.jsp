            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="yhzh" name="yhzh" class="form-control" placeholder="<spring:message code="pubUser.yhzh" />" required maxlength="32" remote="<c:url value='/pubUser/validateYhzh' />" yhzhFormat="true">
                        </div>
                    </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="ssdwmc" name="ssdwmc" class="form-control" placeholder="<spring:message code="pubUser.ssdwmc" />" required readonly="readonly" maxlength="16">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="pkiid" name="pkiid" class="form-control" placeholder="<spring:message code="pubUser.pkiid" />" maxlength="32" noChinese="ture">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="pxdm" name="pxdm" class="form-control" placeholder="<spring:message code="pxdm" />" value="0" maxlength="8" digits="true" onblur="if('' == this.value) this.value = 0">
                        </div>
                    </div>
                    <div class="form-group">
...
$(function () {
    ...
    $('#cancelBtn').click(function(){
        Manage.url("<c:url value='/pubUser/index'/>", {limit: '${param.limit}', offset: '${param.offset}'});
    });
