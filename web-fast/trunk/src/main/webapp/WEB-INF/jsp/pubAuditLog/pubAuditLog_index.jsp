                                ...
                                <form class="form-horizontal">
				                    <div class="row labelpd0">
				                      <div class="form-group col-sm-4">
				                         <label class="col-sm-3 control-label"><spring:message code="pubLog.czms" />:</label>
				                         <div class="col-sm-9">
	                            ...
	                            <table class="table table-bordered" height="auto">
	                                <thead>
	                                    <tr>
	                                        ...
	                                        <th data-field="czms" data-sortable="true" data-sort-name="czms"><spring:message code="pubLog.czms" /></th>
...
$(function () {
    ...
    $("#searchBtn").click(function(){
        ManageGrid.refreshTable(table, pubLogUrl.getDataByPage+"?sjzt=1&yyid="+selectTreeId);
    });
    ...
    $("#appTree").on('select_node.jstree', function (e, data) {
        ...
        if (refreshFlag) {
        	...
        	tableConfig.url = pubLogUrl.getDataByPage+"?sjzt=1&yyid="+selectTreeId;
        	table.bootstrapTable(tableConfig);
        }
