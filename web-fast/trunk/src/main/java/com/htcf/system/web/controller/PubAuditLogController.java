...
/**
 * ClassName: PubAuditLogController<br/>
 * Function: 审计日志管理控制类. <br/>
 * date: 2017年2月18日 上午11:34:06<br/>
 * 
 * @author lizhuo
 */
@Controller
@RequestMapping("/pubAuditLog")
public class PubAuditLogController {

	/**
	 * logger:The Constant logger
	 */
	private static final Logger logger = LogManager.getLogger(PubAuditLogController.class);
	...
	/**
	 * 返回到PubAuditLog index界面.
	 *
	 * @return String
	 */
	@RequestMapping("/index")
	public String index() throws Exception {
		logger.entry("-------返回到pubAuditLog index界面");
		return "/pubAuditLog/pubAuditLog_index";
	}
	 ...
	 * @throws Exception
	 */
	@RequiresPermissions("sys:pubAuditLog:view")
	@RequestMapping(value = "/view/{id}")
	public String view(@PathVariable long id, HttpServletRequest request) throws Exception {
		logger.entry("-------查看审计日志");
		PubLog pubLog = pubLogService.getLogByRzid(id);
		request.setAttribute("pubLog", JsonUtil.toJsonNonNull(pubLog));
		return "pubAuditLog/pubAuditLog_view";
	}
