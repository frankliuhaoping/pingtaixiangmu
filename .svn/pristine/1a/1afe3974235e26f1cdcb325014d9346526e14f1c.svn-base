	...
	<div class="wrapper wrapper-content">
	  <%--tree begin --%>
		...
		<div class="col-sm-10" >
			...
			<div class="col-sm-12" style="padding-left: 0; padding-right: 0px;">
				<div class="ibox float-e-margins">
					<div class="ibox-title col-sm-4">
						<h5>
							<spring:message code="pubRole.select" />
						</h5>
					</div>
							...
							<div class="row labelpd0">
								...
								<div class="form-group col-sm-4">
									<label class="col-sm-3 control-label"><spring:message
											code="pubRole.jsmc" />:</label>
									<div class="col-sm-9">
										<input type="text" id="jsmc" name="jsmc"
		    ...
		    <%-- table begin --%>
		    <div class="col-sm-12" style="padding: 10px 0 10px 0px;">
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						<h5>
							<spring:message code="pubRole.list" />
						</h5>
									...
									<table class="table table-bordered table-striped"
										...
										<thead>
											<tr>
												...
												<th data-field="jsid" data-visible="false"><spring:message
														code="pubRole.jsid" /></th>
												<th data-field="jsmc" data-sortable="true"
													data-sort-name="jsmc"><spring:message
														code="pubRole.jsmc" /></th>
												<th data-field="sybz" data-sortable="true"
													data-sort-name="t.sybz" data-formatter="sybzFormatter"><spring:message
														code="pubRole.sybz" /></th>
												<th data-field="jsms" data-sortable="true"
													data-sort-name="jsms"><spring:message
														code="pubRole.jsms" /></th>
											</tr>
										</thead>
									</table>
...
var pubUserUrl = {
    index: "<c:url value='/pubUser/powerIndex' />",
...
$('#cancelBtn').click(function(){
    Manage.url(pubUserUrl.index + "?yyid=" + yyid, {limit: '${param.limit}', offset: '${param.offset}', selectId: '${param.id}'});
}); 
