            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yymc" name="yymc" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.yymc" />">
                        </div>
                    </div>
                      <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yyqc" name="yyqc" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.yyqc" />">
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="weblj" name="weblj" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.weblj" />">
                        </div>
                    </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="fwlj" name="fwlj" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.fwlj" />">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yydm" name="yydm" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.yydm" />">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yyaqm" name="yyaqm" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.yyaqm" />">
                        </div>
                    </div>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" readonly="readonly" placeholder="<spring:message code="pxdm" />">
                        </div>
                    </div>
                    <div class="form-group">
