            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yymc" name="yymc" class="form-control" readonly="readonly" placeholder="<spring:message code="pubApp.yymc" />" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" readonly="readonly" placeholder="<spring:message code="pxdm" />" value="0" digits="true" onblur="if('' == this.value) this.value = 0">
                        </div>
                    </div>
                    <div class="form-group">
