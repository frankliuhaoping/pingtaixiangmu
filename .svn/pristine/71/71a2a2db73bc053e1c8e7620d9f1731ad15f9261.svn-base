            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="objectKey" name="objectKey" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.objectKey" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <textarea id="objectValue" name="objectValue" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.objectValue" />" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="hitCount" name="hitCount" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.hitCount" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="size" name="size" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.size" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="latestOfCreationAndUpdateTime" name="latestOfCreationAndUpdateTime" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.latestOfCreationAndUpdateTime" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="lastAccessTime" name="lastAccessTime" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.lastAccessTime" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="expirationTime" name="expirationTime" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.expirationTime" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="timeToIdle" name="timeToIdle" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.timeToIdle" />">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="timeToLive" name="timeToLive" class="form-control" readonly="readonly" placeholder="<spring:message code="cacheManagerDetail.timeToLive" />">
                        </div>
                    </div>
...
$(function () {
    ...
    if(expirationTime != null && expirationTime != ''){
        $('#expirationTime').val(moment(expirationTime).format('YYYY-MM-DD HH:mm:ss'));
    }
