            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="cronms" name="cronms" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="rwms" name="rwms" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="ffm" name="ffm" class="form-control" readonly="readonly" >
                        </div>
                    </div>
                    <div class="form-group">
