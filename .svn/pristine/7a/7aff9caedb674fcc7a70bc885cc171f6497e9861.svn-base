            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="zdfName" name="zdfName" class="form-control" placeholder="<spring:message code="pubXtzd.parentZy" />" <c:if test="${not empty zdfName}">value="${zdfName}"</c:if> readonly="readonly">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zdfzdbh" class="col-sm-3 control-label"><span class="fieldRequired">*</span>&nbsp;<spring:message code="pubXtzd.zdfzdbh" />:</label>
                        <div class="col-sm-9">
                            <input id="zdfzdbh" name="zdfzdbh" class="form-control" placeholder="<spring:message code="pubXtzd.zdbh" />" value="${yydm}" readonly />
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="zdxz" class="col-sm-3 control-label"><span class="fieldRequired">*</span>&nbsp;<spring:message code="pubXtzd.zdxz" />:</label>
                        <div class="col-sm-9">
                            <input id="zdxz" name="zdxz" class="form-control" placeholder="<spring:message code="pubXtzd.zdxz" />" required maxlength="32" noChinese="true"/>
                        </div>
                    </div>
                    <div class="form-group">
...
$(function () {
    ...
    $('#cancelBtn').click(function(){
        Manage.url("<c:url value='/pubXtzd/index' />", {yyid: '${param.yyid}'});
    });
