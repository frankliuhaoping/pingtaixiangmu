    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><spring:message code="pubLog.list" /></h5>
                    ...
                    <div class="col-sm-12">
                        <div id="tableToolbar">
                            <div class="form-inline" role="form">
                                <shiro:hasPermission name="sys:pubLog:view">
                                ...
                                <form class="form-horizontal">
				                    <div class="row labelpd0">
				                      <div class="form-group col-sm-4">
				                         <label class="col-sm-3 control-label"><spring:message code="pubLog.fwlj" />:</label>
				                         <div class="col-sm-9">
				                             <input type="text" id="fwlj" name="fwlj" class="form-control">
				                         </div>
				                      </div>
				                      <div class="form-group col-sm-4">
				                         <label class="col-sm-3 control-label"><spring:message code="pubLog.khdip" />:</label>
				                         <div class="col-sm-9">
				                             <input type="text" id="khdip" name="khdip" class="form-control">
				                         </div>
				                      </div>
				                      <div class="form-group col-sm-4">
					                  	  <label class="col-sm-3 control-label"><spring:message code="pubLog.zxzt" />:</label>
					                      <div class="col-sm-9">
					                  ...
					                  <div class="form-group col-sm-4">
                                         ...
                                         <div class="col-sm-9">
                                             <input type="text" id="starttime" name="starttime" readonly="readonly" class="form-control" placeholder="<spring:message code="starttime" />">
                                         </div>
                                      </div>
                                      <div class="form-group col-sm-4">
                                         <label class="col-sm-3 control-label"><spring:message code="endtime" />:</label>
                                         <div class="col-sm-9">
                                             <input type="text" class="form-control" id="endtime" readonly="readonly" name="endtime" placeholder="<spring:message code="endtime" />">
                                         </div>
                                      </div>
                                      </div>
                                      <div class="row labelpd0">
				                      <div class="form-group col-sm-4">
				                         <label class="col-sm-3 control-label"><spring:message code="pubLog.zxsjS" />:</label>
				                         <div class="col-sm-9">
				                             <input type="text" id="zxsjS" name="zxsjS" digits="true" class="form-control">
			                             </div>
			                          </div>
				                      <div class="form-group col-sm-4">
			                             <label class="col-sm-3 control-label"><spring:message code="pubLog.zxsjE" />:</label>
				                         <div class="col-sm-9">
	                            ...
	                            <table class="table table-bordered" height="auto">
	                                <thead>
	                                    <tr>
	                                        ...
	                                        <th data-field="rzid" data-visible="false"><spring:message code="pubLog.rzid" /></th>
	                                        <%-- <th data-field="xtm" data-sortable="true" data-sort-name="xtm"><spring:message code="pubLog.xtm" /></th> --%>
	                                        <th data-field="fwlj" data-sortable="true" data-sort-name="fwlj"><spring:message code="pubLog.fwlj" /></th>
	                                        <th data-field="khdip" data-sortable="true" data-sort-name="khdip"><spring:message code="pubLog.khdip" /></th>
	                                        <th data-field="zxzt" data-sortable="true" data-sort-name="zxzt" data-formatter="zxztFormatter"><spring:message code="pubLog.zxzt" /></th>
	                                        <th data-field="zxsj" data-sortable="true" data-sort-name="zxsj"><spring:message code="pubLog.zxsj" /></th>
...
//url定义
var pubLogUrl = {
    index: "<c:url value='/pubLog/index' />",//日志管理主页面
    view: "<c:url value='/pubLog/view/' />",//查看日志页面
    getDataByPage: "<c:url value='/pubLog/getDataByPage' />"//查看日志分页数据
};
//初始化表格和按钮
$(function () {
    ...
    $("#searchBtn").click(function(){
        ManageGrid.refreshTable(table, pubLogUrl.getDataByPage+"?yyid="+selectTreeId);
    });
    ...
    $("#appTree").on('select_node.jstree', function (e, data) {
        ...
        if (refreshFlag) {
        	...
        	tableConfig.url = pubLogUrl.getDataByPage+"?yyid="+selectTreeId;
        	table.bootstrapTable(tableConfig);
        }
...
function actionFormatter(value, row) {
    ...
    if (viewPer) {
        html += '<a href="javascript:void(0);" onclick="view(\''+row.rzid+'\')" title="<spring:message code="view" />"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a>';
    }
...
// 查看日志
function view(rowId) {
    window.location.href = pubLogUrl.view + rowId + "?limit=" + limit + "&offset=" + offset + "&id=" + rowId;
}
</script>
</body>
</html>