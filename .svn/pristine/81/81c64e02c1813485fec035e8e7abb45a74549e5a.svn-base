...
public class PubLogServiceImpl  implements PubLogService {
	...
	public PubLog addLog(PubLog pubLog) throws Exception {
		...
		//生成uuid
		//Long rzid =pubLogDao.getSeq();
		pubLog.setRzid(UUID.randomUUID().toString().replaceAll("-", ""));
		// 获取审计配置信息
	 ...
	 */
	@Override
	public PubLog getLogByRzid(String rzid) throws Exception {
	...
	public int delelteLog(String... rzids) throws Exception {
		logger.entry("@@@@@@@@@@@@@根据日志Id删除Log", rzids);
		int deleteCount = 0;
		for (String rzid : rzids) {
	 ...
	 * @return
	 * @throws Exception
	 * @see com.htcf.frame.service.LogService#addLog(com.htcf.frame.model.Log)
	 */
	@Override
	public PubLog addLog(Log pubLog) throws Exception {
		// TODO Auto-generated method stub
		Mapper mapper = new DozerBeanMapper();
		PubLog log  = new PubLog();
		mapper.map(pubLog, log);
		return addLog(log);
	}
	 ...
	 * @return
	 * @throws Exception
	 * @see com.htcf.frame.service.LogService#updateLog(com.htcf.frame.model.Log)
	 */
	@Override
	public PubLog updateLog(Log pubLog) throws Exception {
		Mapper mapper = new DozerBeanMapper();
		PubLog log  = new PubLog();
		mapper.map(pubLog, log);
	 ...
	 * @return
	 * @throws Exception
	 * @see com.htcf.frame.service.LogService#addAuditLog(com.htcf.frame.model.Log, java.util.Map)
	 */
	@Override
	public PubLog addAuditLog(Log pubLog, Map<String, Object> msgMap) throws Exception {
		Mapper mapper = new DozerBeanMapper();
		PubLog log  = new PubLog();
		mapper.map(pubLog, log);
		return addAuditLog(log,msgMap);
	}
