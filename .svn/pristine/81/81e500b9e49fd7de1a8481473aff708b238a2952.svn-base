            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="yymc" name="yymc" class="form-control" placeholder="<spring:message code="pubApp.yymc" />" required maxlength="10" remote="<c:url value='/pubApp/validateYymc' />">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="pxdm" name="pxdm" class="form-control" placeholder="<spring:message code="pxdm" />" value="0" digits="true" onblur="if('' == this.value) this.value = 0" digits="true"  maxlength="8">
                        </div>
                    </div>
                    <div class="form-group">
...
//构建应用类型下拉框
addSelect ("<c:url value='/getPubXtzdList' />", "yylx", "system_yylx", null);
