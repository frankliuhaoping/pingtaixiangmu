            ...
            <div class="ibox-content">
                <form class="form-horizontal formW60p">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input id="czms" name="czms" class="form-control" readonly="readonly" placeholder="<spring:message code="pubLog.czms" />" required>
                        </div>
                    </div>
                    <div class="form-group">
...
$(function () {
    $('#backBtn').click(function(){
        window.location.href = "<c:url value='/pubAuditLog/index?selectId=' />" + $('#parentId').val();
    });
