...
<div class="wrapper wrapper-content">
    <div class="col-sm-3" style="padding-left:0;padding-right:10px;">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><spring:message code="pubRole.list" /></h5>
            </div>
    ...
    <div class="col-sm-9" style="padding-left:0;padding-right:0px;">  
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><spring:message code="pubRole.list" /></h5>
...
$(function () {
    ...
    $("#addBtn").click(function(){
    	...
    	Manage.url(pubRoleUrl.add, {limit: limit, offset: offset, yyid : getYyid()});
    });
...
function edit(rowId,yyid) {
	Manage.url(pubRoleUrl.edit + rowId, {limit: limit, offset: offset, yyid: yyid, id: rowId});
    //window.location.href = pubRoleUrl.edit + rowId + "?limit=" + limit + "&offset=" + offset + "&id=" + rowId + "&yyid=" + yyid;
}
function orization(rowId) {
	Manage.url(pubRoleUrl.orization + rowId, {limit: limit, offset: offset, id: rowId});
    //window.location.href = pubRoleUrl.orization + rowId + "?limit=" + limit + "&offset=" + offset + "&id=" + rowId;
}
function del(rowId) {
...
function view(rowId,yyid) {
	Manage.url(pubRoleUrl.edit + rowId, {limit: limit, offset: offset, yyid: yyid, id: rowId});
	//window.location.href = pubRoleUrl.view + rowId + "?limit=" + limit + "&offset=" + offset + "&id=" + rowId + "&yyid=" + yyid;
}
