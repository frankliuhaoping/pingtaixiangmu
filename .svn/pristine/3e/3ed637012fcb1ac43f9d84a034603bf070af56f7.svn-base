    ...
    <div class="wrapper wrapper-content">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h5><i class="fa fa-file-text-o mt2"></i>&nbsp;<spring:message code="pubUser.select" /></h5>
            </div>
            ...
            <div class="ibox-content">
            	<form method="get" class="form-horizontal" id="searchUserForm ">
            		<div class="row labelpd0">
                      ...
                      <div class="form-group col-sm-3">
                         <label class="col-sm-4 control-label"><spring:message code="pubUser.yhmc" />:</label>
                         <div class="col-sm-8">
                      ...
                      <div class="form-group col-sm-6">
                         <label class="col-sm-2 control-label"><spring:message code="pubUser.ssdwmc" />:</label>
                         <div class="col-sm-10" >
                             <input type="text" id="ssdwmc" readonly="readonly" class="form-control timebox">
        ...
        <div class="ibox float-e-margins mt10">
            <div class="ibox-title">
                <h5><i class="fa fa-calculator mt2"></i>&nbsp;<spring:message code="pubUser.list" /></h5>
...
$(function () {
    ...
    $("#addBtn").click(function(){
    	  indexPage = Layer.openIframeByOptions(pubUserUrl.add,{});
    });
...
// 修改用户
function edit(rowId) {
	indexPage = Layer.openIframeByOptions(pubUserUrl.edit + rowId,{});
}
