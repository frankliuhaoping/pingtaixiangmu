	...
	<div class="wrapper wrapper-content">
		...
		<div class="col-sm-10" style="padding-left: 10px; padding-right: 0;">
			<div class="ibox float-e-margins">
				<div class="ibox-title">
					<h5>
						<spring:message code="pubLog.select" />
					</h5>
				</div>
				<div class="ibox-content ">
					<form class="form-horizontal " id="searchUserForm">
						<div class="clearfix labelpd0">
							...
							<div class="form-group col-sm-4">
								<label class="col-sm-3 control-label"><spring:message
										code="pubLog.zxsjE" />:</label>
								<div class="col-sm-9">
									<input type="text" id="zxsjE" name="zxsjE" digits="true"
									    onkeyup="this.value=this.value.replace(/\D/g,'')" 
										class="form-control" digits:true>
								</div>
							</div>

							<div class="form-group col-sm-4">
								<label class="col-sm-3 control-label"><spring:message
										code="pubLog.zxsjS" />:</label>
								<div class="col-sm-9">
									<input type="text" id="zxsjS" name="zxsjS" digits="true"
									 onkeyup="this.value=this.value.replace(/\D/g,'')" 
										class="form-control" >
								</div>
							</div>
			...
			<div class="ibox float-e-margins mt10">
				<div class="ibox-title">
					<h5>
						<spring:message code="pubLog.list" />
					</h5>
						...
						<div class="col-sm-12">
							...
							<div class="table-responsive">
								<table class="table table-bordered table-striped"
									treeGrid="true" height="auto">
									<thead>
										<tr>
											<th data-checkbox="true"></th>
											<th data-field="rzid" data-visible="false"><spring:message
													code="pubLog.rzid" /></th>
											<th data-field="xtm" data-sortable="true"
												data-sort-name="xtm"><spring:message code="pubLog.xtm" /></th>
											...
											<th data-field="zxzt" data-sortable="true"
												data-sort-name="zxzt" data-formatter="zxztFormatter"><spring:message
													code="pubLog.zxzt" /></th>
											<th data-field="zxsj" data-sortable="true"
												data-sort-name="zxsj"><spring:message
													code="pubLog.zxsj" /></th>
