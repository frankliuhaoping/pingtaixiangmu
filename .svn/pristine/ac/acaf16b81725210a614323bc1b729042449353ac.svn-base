	                        ...
	                        <div class="row J_mainContent col-sm-10">
		                        <div class="row">
								    <div class="col-md-4" style="margin-left: 50px;width: 85%;">
								        <div class="ibox float-e-margins" style="margin-bottom:10px" id="myRecord">
											<div class="ibox-title">
...
function loadSelectedTree(){
	...
	var url = "<c:url value='/pubZzjgsy/getSelectedOrgTree2' />";
	Manage.query (url, {zdbh:selectTreeId}, function (result){
		authTree.jstree({
			'checkbox': {
				'keep_selected_style': false,
				'three_state':false
